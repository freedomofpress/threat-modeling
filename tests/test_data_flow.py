...
def test_dataflow_str():
    test_id = "Server"
    element = Dataflow(name="Primary Server", identifier=test_id, first_id='teehee',
                       second_id='butts')
...
def test_bidirectionaldataflow_str():
    test_id = "Server"
    element = BidirectionalDataflow(name="Primary Server",
                                    identifier=test_id, first_id='teehee',
                                    second_id='butts')
